...
def get_jurassic_document_prompt(question, context):
    

    document_prompt_template = f"""You are a friendly customer service agent.I want you to provide an answer to the question using the following context. 
